...
def decision_envelope(*, outcome: str, will_name: Optional[str], scope: Dict[str, Optional[str]],
                      ...
                      consent_checked_at: Optional[str] = None,
                      consent_status_before_delivery: Optional[str] = None,
                      consent_checked_at_before_delivery: Optional[str] = None) -> Dict[str, Any]:
    ...
    return {
        ...
        "consent_status_before_delivery": consent_status_before_delivery,
        "consent_checked_at_before_delivery": consent_checked_at_before_delivery,
    }
