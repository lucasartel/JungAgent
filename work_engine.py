...
# NOTE: DEFAULT_PROVIDER_SPECS is intentionally kept here (not imported from
# work.providers) because this copy has 7 provider entries (wordpress, github,
# google_drive, google_calendar, railway, google, asana) while work/providers.py
# only defines wordpress and github. Reconciling the two copies is deferred to
# Corte 2+ once the planned-provider entries are properly represented there.
# Divergence reported: work/providers.py DEFAULT_PROVIDER_SPECS is missing
# google_drive, google_calendar, railway, google, asana.
...
from work.providers import GitHubSkill, WordPressSkill


class WorkEngine(WorkProjectMixin, WorkBriefMixin, GitHubWorkMixin):
