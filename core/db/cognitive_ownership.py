...
OWNERSHIP_CONTRACTS: Tuple[CognitiveOwnershipContract, ...] = (
    ...
    _c("structured_facts", ("user_facts", "user_facts_v2", "user_patterns", "user_milestones", "psychometric_evidence"),
       ...
       "Map admin facts explicitly; never infer ownership from user_id alone.", PARTIAL, "C12e",
       "Facts and runtime patterns are Relation-scoped; milestones and psychometrics remain for C12e."),
