...
- **Contrato canonico**: `cognitive_ownership_contract.py` inventaria 23 dominios persistentes e de contexto, registrando stores, classe atual e alvo, chaves de escopo, origem, destino, retencao, permissao, politica de prompt, tratamento do legado do admin, prontidao e corte responsavel. O relatorio legivel pode ser gerado com `python cognitive_ownership_contract.py --format markdown`; JSON esta disponivel com `--format json`.
